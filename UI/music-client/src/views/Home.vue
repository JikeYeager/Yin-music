<template>
  <!--轮播图-->
<!--v-if="swiperList.length"判断轮播图数组是否为空，若不为空则往下执行  -->
<!-- v-for="(item, index) in swiperList" 循环播放轮播图-->
<!--  <img :src="HttpManager.attachImageUrl(item.pic)" />  每次循环都去获取一次图片-->
