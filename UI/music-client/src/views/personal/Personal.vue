...
<!--      显示用户信息 （用户名username和个性签名introduction）-->
...
<!--    上传头像 ,双向绑定dialogTableVisible，用于显示上传框 -->
...
export default defineComponent({
  ...
  setup() {
    ...
    async function getCollection(userId) {
      ...
      //返回的结果赋值给collectSongList用于显示
      collectSongList.value = result.data
    ...
    // nextTick 就是 “等 Vue 忙完手头的更新，再干别的事”，避免拿到旧数据或操作未更新的 DOM
    nextTick(() => {
