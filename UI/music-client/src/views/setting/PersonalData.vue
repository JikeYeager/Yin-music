...
import {AREA, RouterName, SignUpRules} from "@/enums";
...
export default defineComponent({
  setup() {
    ...
    const { goBack } = mixin();
    //在这里routerManager通过mixin实例化后，我们才能拿出来用
    ...
    async function saveMsg() {
      ...
      const param = {id,username,sex,phoneNum,email,birth,introduction,location}

      //2. 发送请求
      const result = (await HttpManager.updateUserMsg(param)) as ResponseBody
      //3. 提示信息
